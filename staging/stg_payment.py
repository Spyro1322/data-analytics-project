...
with base as (
  select *
  from `diesel-media-457308-t3.pagila_productionpublic.payment` --Your table path
  )
...
get_ipython().system('python3 -m jupyter nbconvert stg_language.ipynb --to python')
